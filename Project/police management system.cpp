...
int login()
{
  ...
  do
  {
    ...
    cout << "Password : ";
    cin >> password;
    if(strcmp(username,"swapnil")==0 && strcmp(password,"Cloud16")==0)
      {
        cout << "\n\n";
        cout << "\t\t\t\t";
...
void mainpage()
{
  ...
  cout <<"Prepared By    ";
  cout <<":";
  cout <<"   Swapnil Jaysingpure - 223026";
  cout <<"\n";
  cout <<"                                                   Yashwant Guldagad   - 223022";
  cout <<"\n";
  cout <<"                                                   Kunal Ambekar       - 223001";
  cout <<"\n";
  cout <<"                                                   Shreyash Deodare    - 223014";
  cout <<"\n\n";
  cout <<"\t\t\t\t";
  cout <<"Mini Project   ";
  cout <<":";
